        ...
        <>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 12, marginBottom: 16 }}>
            {(() => {
              ...
              const weightVal = cv("weight_kg", shipment.weight_kg ? `${shipment.weight_kg} kg` : "—");
              ...
              return <>
                ...
                <Card title="Paquete">
                  ...
                  <InfoRowEx value={weightVal.corrected ? `${cor.weight_kg} kg` : (shipment.weight_kg ? `${shipment.weight_kg} kg` : "—")} original={shipment.weight_kg ? `${shipment.weight_kg} kg` : "—"} corrected={weightVal.corrected} label="Peso" />
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
      <div style={{ background: "#fff", borderRadius: 12, padding: 24, maxWidth: 680, width: "100%", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        ...
        <fieldset style={{ ...fsStyle, marginTop: 12 }}>
          <legend style={legStyle}>Paquete</legend>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 10 }}>
            <DField label="Peso (kg)"><input style={inp} type="number" step="0.1" min="0.1" value={form.weight_kg || ""} onChange={(e) => set("weight_kg", parseFloat(e.target.value) || 0)} placeholder="Sin definir" /></DField>
            <DField label="Tipo">
