...
func TestCoverage_Diagnose_PercentageAndDeficit(t *testing.T) {
	...
	res := svc.Diagnose(simArea, nil, nil, false, 0, false, "", model.DensityOptions{})
...
func TestMathematicalSuggestions_SmallCustomZone(t *testing.T) {
	...
	res := svc.Diagnose(simArea, amba, nil, false, 0, false, "", model.DensityOptions{})
...
func TestMathematicalSuggestions_ZeroBranches(t *testing.T) {
	...
	res := svc.Diagnose(10_000.0, amba, nil, false, 0, false, "", model.DensityOptions{})
...
func TestMathematicalSuggestions_DangerousZoneExcluded(t *testing.T) {
	...
	res := svc.Diagnose(10_000.0, amba, [][]model.LatLng{danger}, false, 0, false, "", model.DensityOptions{})
