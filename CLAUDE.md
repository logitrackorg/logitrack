...
**Value objects**: `Address` (street, city, province, postal_code), `Status` (enum), `PackageType` (enum: envelope, box, pallet), `ShipmentType` (enum: normal, express), `TimeWindow` (enum: morning, afternoon, flexible), `Role` (enum).
