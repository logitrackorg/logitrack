...
- Operators cannot execute `delivering → delivered` (reserved for supervisor, admin, and driver). Other transitions to `delivered` (e.g. `ready_for_pickup → delivered`) are allowed.
